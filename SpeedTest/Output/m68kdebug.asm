...
; //
; // xxxx_xxxx_xxxx_xxxx_xxxx_xxxx_nnnn_nnnn
; // 0x00FF
; int read_back;
...
; //mem_pointer = 0x08000000; // preserve the old value after WriteSPIFlashData
; printf("\r\nVerifying the read....");
       pea       @m68kde~2_26.L
       jsr       (A2)
       addq.w    #4,A7
...
@m68kde~2_24:
       ...
       dc.b      103,114,97,109,32,116,111,32,102,108,97,115
       dc.b      104,46,46,46,46,0
@m68kde~2_25:
       dc.b      13,10,42,42,42,42,42,42,42,42,70,108,97,115
       dc.b      104,32,80,114,111,103,114,97,109,109,101,100
       dc.b      42,42,42,42,42,42,42,42,0
@m68kde~2_26:
